...
3. All training data and data related to species is downloaded in "data" directory
4. We store pretrained models under "models" direcotry
5. In "nas" directory we have modules from [NNI](https://github.com/microsoft/nni) to support QABAS
6. In "rubicall" we provide all the necessary tools, scripts, dataset, and commands to reproduce the results in our paper
...
RUBICON is designed using official ONT [Bonito](https://github.com/nanoporetech/bonito) project. 
